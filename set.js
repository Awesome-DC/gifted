...
global.caption = "*©𝟐𝟎𝟐𝟒 BANKAI 𝐌𝐃*"; // Input Yours custom...(Maintain font for Flow)
...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~7zITEJhJ#6_wpGIrQq2b8_2V_-vc8ADeDD-evwSF57ca8hEgCZFQ", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "2349129158834", // Only 1 owner Number Here, others Add to sudo numbers...
...
BOT_NAME: process.env.BOT_NAME || "BANKAI-𝐌𝐃", // Input Yours custom...(Maintain font for Flow)
